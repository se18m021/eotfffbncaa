...
internal class KotlinMetricCalculatorDITTest : AbstractMetricCalculatorTest(
    metricName = "DIT",
    resourcesFolder = "kotlin/dit",
    ...
    @Test
    fun `(DitC) DIT for class inheriting by fully qualified name`() {
        assertMetric("DitC", 2)
    }
